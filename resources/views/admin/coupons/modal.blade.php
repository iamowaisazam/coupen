<div style="padding-right: 17px;display: block;" class="modal fade show" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" role="dialog">

    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
      <div class="modal-content">
        <form method="post" enctype="multipart/form-data" action="{{URL::to('admin/coupons/update/')}}/{{Crypt::encryptString($module->id)}}" >
         @csrf
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit Coupen</h5>
          <a href="{{URL::to('admin/coupons/index')}}" ><span aria-hidden="true">&times;</span></a>
        </div>
        ...
        <div class="modal-footer">
            <a class="btn btn-secondary" href="{{URL::to('admin/coupons/index')}}">Close</a>
